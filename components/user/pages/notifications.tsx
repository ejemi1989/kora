...
export function NotificationsPage() {
    ...
    return (
      <div>
        ...
        <div style={{ background: "#fff", borderRadius: 8, boxShadow: "0 0 0 1px rgba(0,0,0,0.04), 0 1px 2px rgba(0,0,0,0.04)", padding: 20, maxWidth: 480 }}>
          ...
          <div style={{ fontSize: 11, color: "var(--ash)", marginBottom: 12 }}>{notif.time}</div>
  ...
  return (
    <div>
      ...
      <p style={{ fontSize: 13, color: "var(--muted)", marginBottom: 16 }}>{unreadCount} unread</p>
      ...
      {notifs.map((n) => (
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ fontSize: 12, color: "var(--muted)", marginBottom: 2 }}>{n.description}</div>
